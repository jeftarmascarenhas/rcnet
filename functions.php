<?php 
/**
 * Level System functions and definitions.
 *
...
if(!defined('WP_SCRIPT_URL')) { define('WP_SCRIPT_URL', WP_THEME_URL . '/public/js'); }
if(!defined('WP_STYLE_URL'))  { define('WP_STYLE_URL', WP_THEME_URL . '/public/css'); }
if(!defined('WP_IMAGE_URL'))  { define('WP_IMAGE_URL', WP_THEME_URL . '/public/images'); }
...
require_once($functions_path . 'posttype.php');
require_once($functions_path . 'wp_bootstrap_navwalker.php');
// require_once($functions_path . 'attachments.php');
