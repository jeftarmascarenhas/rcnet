...
function enqueue_scripts() {
    ...
    wp_enqueue_script('jquery');
        ...
        wp_register_script('bootstrap', 'http://maxcdn.bootstrapcdn.com/bootstrap/3.3.1/js/bootstrap.min.js', array(), null, true);
    wp_enqueue_script('bootstrap');

    wp_register_script('modernizr', WP_SCRIPT_URL . '/vendor/modernizr-2.6.2.min.js', array(), null, false);
    wp_enqueue_script('modernizr');

    wp_register_script('main', WP_SCRIPT_URL . '/app.min.js', array(), null, true);
...
function enqueue_stylesheet($uri, $dir) {
    return $dir . '/public/css/style.css';
}
